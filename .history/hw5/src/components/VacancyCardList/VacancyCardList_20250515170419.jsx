...
import Sony from "../../assets/Sony-vacancy-card.svg";
import Facebook from "../../assets/Facebook-vacancy-card.svg";
import Cola from "../../assets/Cola-vacancy-card.svg";

// Component for displaying a list of vacancy cards
function VacancyCardList() {
  // Array containing information about each vacancy
  const vacancyInfo = [
    {
